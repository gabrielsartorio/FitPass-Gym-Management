...
O ***GERENTE*** deve poder emitir relatórios como: inadimplência, alunos ativos, histórico de acessos e ocupação das aulas

RF10 — ***NOTIFICAÇÕES***
O sistema deve enviar notificações ao aluno sobre: vencimento de mensalidade, confirmação de agendamento e liberação de nova avaliação física
